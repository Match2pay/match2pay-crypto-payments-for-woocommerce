...
class Match2Pay_Hooks {
	...
	public function define_woocommerce_hooks(): void {
		...
		add_action( 'wc_ajax_wc_match2pay_get_payment_form_data', [
		...
		add_action( 'wp_ajax_match2pay_orderpay_payment_request', [
			Payment_Gateway::class,
			'match2pay_ajax_orderpay_payment_request'
		] );
		add_action( 'wp_ajax_nopriv_match2pay_orderpay_payment_request', [
			Payment_Gateway::class,
			'match2pay_ajax_orderpay_payment_request'
		] );
